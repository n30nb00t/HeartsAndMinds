...
if (isServer) then {
    ...
    btc_city_blacklist = ["Comms Bravo", "Comms Alpha"];//NAME FROM CFG
    ...
    btc_vehicles = [btc_veh_2, btc_veh_3, btc_veh_4, btc_veh_5, btc_veh_6, btc_veh_7, btc_veh_8, btc_veh_9, btc_veh_10, btc_veh_11, btc_veh_12, btc_veh_13, btc_veh_14, btc_veh_15, btc_veh_16, btc_veh_17, btc_veh_18, btc_veh_19];
    btc_vehicles = btc_vehicles + [btc_helo_2, btc_helo_3, btc_helo_4];
    btc_helo = [btc_helo_1];
